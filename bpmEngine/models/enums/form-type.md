...
| Değer | Anlam | Ne için |
|---|---|---|
| `form` | Akışı olan, akışla **instance** oluşan, `Instance.creatorUserId` **dolu**, onay akışı işleyen ve `InstanceAwaitingUser` kaydı olabilen servis. | Sahipli, onaya tabi standart süreçler (ör. masraf formu). |
