...
> **Kullanan model:** [`business-rule-condition.md`](../service-settings/business-rule-condition.md) — `referenceValue` / `valueToCompare` tipi, tip **BusinessRuleConditionCompareType**
