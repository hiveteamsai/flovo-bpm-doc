...
> **Amaç:** Bir zamanlayıcı kaydının yaşam döngüsü konumu. Scheduler yalnız `armed` kayıtları tarar (→ [`../../engine-runtime-scheduler.md`](../../engine-runtime-scheduler.md) §1).
...
## Notlar
- `fired` ve `cancelled` **terminal**dir; yeni kurulum = **yeni satır** (geçmiş korunur, saklama → [`../../engine-runtime-retention.md`](../../engine-runtime-retention.md)).
