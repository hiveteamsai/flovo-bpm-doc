...
- Flovo motor → `../../architectures/engine-core/flovo-bpm-engine.md` · adımlar → `../../service-settings/process-step.md` · aksiyon → `../../service-settings/process-step-action.md`
- Flovo Customer API → `../../architectures/api/flovo-customer-api.md` · çeviri → `../../organization-settings/translation.md` · organizasyon → `../../organization-settings/organization.md`
