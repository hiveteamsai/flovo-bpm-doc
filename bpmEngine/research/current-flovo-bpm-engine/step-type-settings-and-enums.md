...
**Taşıma kararı (🟢):** `ProcessStep` modelindeki **22 adım tipine** göre isimlendirilmiş bir **`ProcessStepType`** enum'u
...
> ayrıştırıldı (22 adım tipiyle ilgisi yok). Ayrı `NotificationUserGroupType` **kaldırıldı** (değerleri buraya toplandı); bildirim
...
| — | `ProcessStepType` | 🔤 | yeni; §3'teki 22 adımdan |
