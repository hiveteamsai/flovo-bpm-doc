...
| `code` | string | **Çeviri eşleşme kodu** — `../genel-ayarlar/translation.md` `code`'u ile eşleşir; öğe metni buradan çözülür |
...
> - **Görünen metin:** `code` → `../genel-ayarlar/translation.md` §3 çözümlemesiyle **aktif dile** göre gösterilir.
